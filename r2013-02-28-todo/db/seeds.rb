...
t1 = Task.create(:title => 'Homework', :description => 'Finish all wdi homework', :due_date => '2013/02/27')
t2 = Task.create(:title => 'Buy groceries', :description => 'Buy groceries after work', :due_date => '2013/03/27')
t3 = Task.create(:title => 'Get milk', :description => 'Buy milk from the shop', :due_date => '2013/03/05')
t4 = Task.create(:title => 'Fitness', :description => 'Go for a run at the park', :due_date => '2013/03/01')
